...
import { signal, computed, batch, effect, For, Show, Switch, Match } from 'zenjs';
import { FineGrainedDemo, BatchDemo, MemoryDemo } from './Showcase';
...
function Counter() {
  ...
  return (
    <div class="demo-card">
      ...
      <div class="stats">
        <div><strong>Doubled:</strong> {doubled}</div>
        <div><strong>Squared:</strong> {squared}</div>
      </div>
