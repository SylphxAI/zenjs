...
export function Benchmark() {
  ...
  input.oninput = () => iterations.value = parseInt(input.value) || 1000000;
  ...
  runBtn.onclick = async () => {
    ...
    result.value = `Completed ${count.toLocaleString()} updates in ${duration.toFixed(2)}ms\n` +
  ...
  ['Framework', 'Bundle Size', 'Signal Ops/sec', 'Virtual DOM', 'First-Class Signals'].forEach(text => {
